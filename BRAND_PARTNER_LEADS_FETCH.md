...
| `email` | string | Email address | "N/A" if not provided |
| `phone` | string | Primary phone number | "N/A" if not provided |
| `alternatePhone` | string | Alternate phone number | "N/A" if not provided |
| `address` | string | Full address | "N/A" if not provided |
